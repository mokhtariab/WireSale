...
{
    public partial class ChartDateWCompare_UC : UserControl
    {
        public ChartDateWCompare_UC()
        {
            InitializeComponent();
        }
        ...
        private void ChartDateWCompare_UC_Load(object sender, EventArgs e)
        {
            LoadChart(chartControlCmp1, _SelTypeChart, _AxAmountPercent, _SelSeries, _SortType, _Date1, _Date2,_DateType, _WCode, _Title);
            LoadChart(chartControlCmp2, _SelTypeChart, _AxAmountPercent, _SelSeries, _SortType, _Date1.AddYears(-1), _Date2.AddYears(-1), _DateType, _WCode, _Title1);
            LoadChart(chartControlCmp3, _SelTypeChart, _AxAmountPercent, _SelSeries, _SortType, _Date1.AddYears(-2), _Date2.AddYears(-2), _DateType, _WCode, _Title2);
            LoadChart(chartControlCmp4, _SelTypeChart, _AxAmountPercent, _SelSeries, _SortType, _Date1.AddYears(-3), _Date2.AddYears(-3), _DateType, _WCode, _Title3);
        }
        ...
        private void SetTitle(DevExpress.XtraCharts.ChartControl Chart, string TitleStr)
        {
            ...
            df.Text = TitleStr;
            df.Font = new System.Drawing.Font("Tahoma", 10.18868F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            Chart.Titles.Add(df);
        }

        public void LoadChart(DevExpress.XtraCharts.ChartControl Chart, int ChartType, bool Amount_Percent, string SelSeries, int SortType, DateTime Date1, DateTime Date2, int DateType, string WCodeStr, string TitleStr)
        {
            ...
            Data(Chart, SelSeries, Date1, Date2, DateType, WCodeStr);
        ...
        private void Data(DevExpress.XtraCharts.ChartControl Chart, string SelSeries, DateTime date1, DateTime date2, int DateType, string WireCodeStr)
        {
            string Order = "";
            if (_SortType == 1)
            ...
            if (DateType == 0)
            {
                ...
                if (DateType == 1)
                {
                    ...
                    if (SelSeries.Contains("am;"))
                    {
                        Chart.Series[0].DataSource = gk.Tables[0];
                        Chart.Series[0].ArgumentDataMember = "ActionMonth";
                        Chart.Series[0].ValueDataMembers[0] = "Inventory";
                    }
                    if (SelSeries.Contains("by;"))
                    {
                        Chart.Series[1].DataSource = gk.Tables[0];
                        Chart.Series[1].ArgumentDataMember = "ActionMonth";
                        Chart.Series[1].ValueDataMembers[0] = "Buy";
                    }
                    if (SelSeries.Contains("sl;"))
                    {
                        Chart.Series[2].DataSource = gk.Tables[0];
                        Chart.Series[2].ArgumentDataMember = "ActionMonth";
                        Chart.Series[2].ValueDataMembers[0] = "Sale";
                    }
                    SqlConn.Close();
